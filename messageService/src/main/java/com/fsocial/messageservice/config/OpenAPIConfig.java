...
public class OpenAPIConfig {
    ...
    public OpenAPI customOpenAPI() {
        ...
        Server gatewayServer = new Server()
                .url("http://localhost:8888/api/v1/message")
                .description("API Gateway Server");
        
        // Direct service server - for development
        Server localServer = new Server()
                .url("http://localhost:" + serverPort + "/message")
        ...
        return new OpenAPI()
                .info(new Info()
                        ...
                        .version("1.0")
                        .description("API documentation for Message Service - Quản lý tin nhắn, chat và conversation")
                        .license(new License()
                                .name("API License")
