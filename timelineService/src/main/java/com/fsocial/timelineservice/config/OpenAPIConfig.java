...
public class OpenAPIConfig {
    ...
    public OpenAPI customOpenAPI() {
        ...
        Server gatewayServer = new Server()
                .url("http://localhost:8888/api/v1/timeline")
                .description("API Gateway Server");
        
        // Direct service server - for development
        Server localServer = new Server()
                .url("http://localhost:" + serverPort + "/timeline")
        ...
        return new OpenAPI()
                .info(new Info()
                        ...
                        .version("1.0")
                        .description("API documentation for Timeline - quản lý lấy bài viết, comment, react, report")
                        .license(new License()
                                .name("API License")
